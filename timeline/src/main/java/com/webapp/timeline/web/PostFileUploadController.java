...
public class PostFileUploadController {
    ...
    public ResponseEntity filesUpload(@RequestParam("postId") long postId,
        ...
        try {
            return new ResponseEntity<>(postServiceImpl.uploadImages(postId, files), header, HttpStatus.CREATED);
